...
$(document).ready(function() {
    ...
    var chart = new ApexCharts(document.querySelector("#apex-BTC"),options); chart.render();
});
// ETC
$(document).ready(function() {
    var options = {
    ...
    var chart = new ApexCharts(document.querySelector("#apex-ETC"),options); chart.render();
});
