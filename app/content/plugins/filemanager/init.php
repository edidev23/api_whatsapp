...
define('APPPATH', BASEPATH . $d_s . 'application' . $d_s);
define('LIBBATH', BASEPATH . "{$d_s}system{$d_s}libraries{$d_s}Session{$d_s}");

require_once LIBBATH . 'Session_driver.php';
require_once LIBBATH . "drivers{$d_s}Session_files_driver.php";
require_once BASEPATH . "{$d_s}system{$d_s}core{$d_s}Common.php";
